...
@section('title', 'Tambah Rekening Koperasi')
...
<div class="space-y-3">
    <div class="bg-white border border-gray-200 rounded-xl p-6 shadow-sm max-w-2xl">
        <div class="mb-4">
            <h2 class="text-base font-semibold text-gray-800">Tambah Rekening Koperasi</h2>
            <p class="text-sm text-gray-500">Tambahkan master rekening bank koperasi.</p>
        </div>

        <form method="POST" action="{{ route('admin.master.rekening-koperasi.store') }}" class="space-y-4">
            @csrf
            ...
            <label class="inline-flex items-center gap-2">
                <input type="checkbox" name="aktif" value="1" {{ old('aktif', '1') ? 'checked' : '' }} class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
